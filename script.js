...
function injury_text(){
    var slot = document.getElementById("content");
    let text = "Despite being placed higher on the NFL rankings than the Vikings (3 vs 6), the Saints lost their playoff game against them in this past season. Unfortunately, the star player for the Saints, Drew Brees, was injured --- and was out for 6 weeks. Since Brees was back for this game we decided to look at Brees’ --- before and after his injury to see if he got worse after and if this could have been a variable in the loss against the Vikings. We found that overall, his statistics were generally better after his injury. This would lead us to believe that the excuse of the Drew Brees is likely not an example of the Saint’s bad luck.";
